...
const StudentDashboard = () => {
    ...
    const userType = 'student'; // Already confirmed by the ProtectedRoute
        ...
        <div className="min-h-screen bg-[#f1f3f3] flex flex-col pt-20"> 
            ...
            <header className="fixed top-0 left-0 w-full flex items-center justify-between p-4 bg-white shadow-md z-10">
                ...
                <button
                    ...
                    className="bg-red-500 text-white text-sm py-2 px-4 rounded-lg font-semibold hover:bg-red-600 transition-colors"
                >
                    Log Out
                </button>
            </header>
            ...
            <main className="flex-1 flex flex-col justify-center items-center p-8"> 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
                    ...
                    <DashboardCard
                        title="Join Live Whiteboard"
                        description="Access the teacher's real-time interactive session."
                    ...
                    <DashboardCard
                        ...
                        description="View course materials, check assignments, and monitor your progress."
                        linkTo={COURSES_PATH}
                        icon="📚"
                    />
                </div>
